...
export const LoginScreen: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Prevent local-save hooks from overwriting an existing Firestore account while
      // we switch the local account snapshot. The UID is restored immediately after.
      ...
      // Never block the login screen on Firestore/network latency. Existing cloud data
      // is loaded in the background and the app refreshes once that snapshot arrives.
      void (async () => {

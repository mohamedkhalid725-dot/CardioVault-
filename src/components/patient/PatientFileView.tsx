...
export const PatientFileView: React.FC = () => {
  ...
  const renderSection = () => {
    switch(activePatientSection){
      ...
      case 'cardiology': return <CardiologySection patient={currentPatient}/>;
  ...
  return <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-[#0A0F1D] text-slate-900 dark:text-slate-100">
    ...
    <PatientFileNav/>
    <main className="flex-1 max-w-7xl w-full mx-auto px-3 sm:px-6 pb-24 md:pb-12">{renderSection()}</main>

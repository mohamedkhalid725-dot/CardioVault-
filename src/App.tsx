...
const AppContent: React.FC = () => {
  const { auth, currentView, toasts, dismissToast } = useApp();
  ...
  const render = () => {
    switch (currentView) {
      case 'home': return <UnitsDashboard />;
      case 'census': return <UnitCensusView />;
      case 'handover': return <HandoverView />;
      case 'patient': return <PatientFileView />;
      case 'patients': return <ActivePatientsView />;
      case 'add-patient': return <AddPatientPage />;
      case 'archive': return <ArchiveView />;
      case 'calculators': return <CalculatorsHub />;
      case 'settings': return <SettingsView />;
      default: return <UnitsDashboard />;
    }
  };
